...
- **Aktueller Stand:** Tag **`v1.41.0`** · **271 PHPUnit-Tests / 947 Assertions** + **10 Dusk-E2E-Tests / 36 Assertions** durchgehend grün · `composer lint` (Pint + PHPStan Level 5) sauber
